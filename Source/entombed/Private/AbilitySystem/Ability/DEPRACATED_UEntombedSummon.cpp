...
#include "AbilitySystem/Ability/DEPRECATED_UEntombedSummonAbility.h"

TArray<FVector> UDEPRECATED_UEntombedSummonAbility::GetSpawnLocations()
{
...
TSubclassOf<APawn> UDEPRECATED_UEntombedSummonAbility::GetRandomMinionClass()
{
