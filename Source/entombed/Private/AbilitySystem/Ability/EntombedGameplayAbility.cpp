...
FString UEntombedGameplayAbility::GetLevelDescription(int32 Level)
{
...
FString UEntombedGameplayAbility::GetNextLevelDescription(int32 Level)
{
	return FString::Printf(TEXT("<Default>Next Level: </><Level>%d</> \n<Default>More Damage.</>"), Level);
}

FString UEntombedGameplayAbility::GetLockedDescription(int32 Level)
{
	return FString::Printf(TEXT("<Default>Ability Locked until Level: </><Level>%d</>"), Level);
}

float UEntombedGameplayAbility::GetCost(float InLevel) const
{
	float Cost = 0.f;
...
float UEntombedGameplayAbility::GetCooldown(float InLevel)
{
	float Cooldown = 0.f;
