...
#include "EntombedHostileCharacter.generated.h"
 ...
 */
UCLASS()
class ENTOMBED_API AEntombedHostileCharacter : public AEntombedBaseCharacter, public ITargetInterface, public IHostileInterface
{
	GENERATED_BODY()

public:
	AEntombedHostileCharacter();
