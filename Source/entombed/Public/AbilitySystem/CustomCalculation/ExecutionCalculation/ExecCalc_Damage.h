 ...
 */
UCLASS()
class ENTOMBED_API UExecCalc_Damage : public UGameplayEffectExecutionCalculation
{
	GENERATED_BODY()
...
public:
	...
	void DetermineRadialDamage(AActor* SourceActor, AActor* TargetActor, FGameplayEffectContextHandle EffectContextHandle, float& DamageTypeValue) const;
